...
class ModelCCS(Model_CPG):
    ...
    def set_physics(self): #NEW
        ...
        facies_rel_perm = {  # based on fluidflower paper
            ...
            1: Corey(nw=1.5, ng=1.5, swc=0.12, sgc=0.10, krwe=1.0, krge=1.0, labda=2., p_entry=0.038706, pcmax=300, c2=1.5),  # p_entry=0.038706
            # **Shale (Facies 3)**
            2: Corey(nw=1.5, ng=1.5, swc=0.32, sgc=0.10, krwe=1.0, krge=1.0, labda=2., p_entry=1.935314, pcmax=300, c2=1.5)}  # p_entry=1.935314
    ...
    def set_input_data(self, case=''):
        ...
        self.idata.obl.thermal = True #True #True #This sets case to non-isothermal
